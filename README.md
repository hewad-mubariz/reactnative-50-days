...
> **⚠️ Heads-up:** These are **challenge demos** (ideas + motion), not hardened production components. Animations and effects are not all optimized for every device—**profile on real hardware**, tweak timings, and trim work before shipping anything based on them.
